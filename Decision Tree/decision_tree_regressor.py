...
Original file is located at
    https://colab.research.google.com/drive/1cq-NFk5SB5CqltOnNCb5UpYgZEsnd6ij
...
print(f"Score with trining model is: {decision_tree_training_set_score}")
...
"""# Decision tree is giving a great accuracy."""
