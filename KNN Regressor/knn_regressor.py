...
Original file is located at
    https://colab.research.google.com/drive/1LvTWhKLO14vVY7bSzs0mnqbvT747TBVl
...
knn_training_set_score = knn_model.score(X_train, y_train)
print(f"KNN model's score with training set is: {knn_training_set_score}")

#Model's score with test set
knn_test_set_score = knn_model.score(X_test, y_test)
print(f"KNN model's score with test set is: {knn_test_set_score}")

#Model's score with full set
knn_full_set_score = knn_model.score(X, y)
print(f"KNN model's score with full set is: {knn_full_set_score}")

"""#KNN is providing a very bad accuracy"""